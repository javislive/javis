...
class ViewPager extends Component<ViewPagerProps> {
  private _pageSelected: number | undefined;
  ...
  _onScroll(e: BaseSyntheticEvent<NativeScrollEvent>) {
    ...
    this.props.onPageScroll &&
      this.props.onPageScroll({ nativeEvent: { offset, position } });
  }

  _onPageSelected(
    e: NativeSyntheticEvent<ViewPagerAndroidOnPageSelectedEventData>
  ) {
  ...
  _childrenWithOverridenStyle(): any[] {
  ...
  render() {
    ...
    let props = {
      ...
      scrollsToTop: false,
      ref: VIEWPAGER_REF,
      contentOffset: { x: width * initialPage || 0, y: 0 },
